...
public class FuncionarioController {
    ...
    public ResponseEntity<Funcionario> atualizarSalario(@PathVariable int id, @RequestBody double novoSalario) {
        Funcionario funcionarioAtualizado = funcionarioService.atualizarSalario(id, novoSalario);
